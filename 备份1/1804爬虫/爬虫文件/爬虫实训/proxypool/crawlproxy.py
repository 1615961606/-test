...
class CrawlProxy(object):
    ...
    def __init__(self,req_url,max_size=500,time=2*60):
        #设置数据库中存储的代理的最大的量，超过1000,则暂停爬取
        ...
        self.checkIp = ckeckip.CheckIp(test_url='https://www.baidu.com/')
        self.thread = threading.Timer(self.time, self.check_need_get_proxy)
        self.thread.start()

    #定时比对如果代理池中的代理数小于1000,则发起请求获取代理
