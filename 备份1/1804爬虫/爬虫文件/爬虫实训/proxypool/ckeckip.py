...
class CheckIp(object):
    ...
    def __init__(self,test_url,timeout=5,req_header={'User-Agent':'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.13; rv:60.0) Gecko/20100101 Firefox/60.0'}):
        #要检测的url,用来判断ip是否可用
    ...
    def check_proxy_with_proxies(self,proxies):
        ...
        if len(proxies) > 0 :
            ...
            for proxy in proxies:
                ...
                status, usedtime = self.check_proxy_isused(proxy_dict)
                if status == True:
